declare namespace NaiveUI {
	...
	type TableColumnCheck = import('@lifeatm/hooks').TableColumnCheck
	type TableDataWithIndex<T> = import('@lifeatm/hooks').TableDataWithIndex<T>
	type FlatResponseData<T> = import('@lifeatm/axios').FlatResponseData<T>
	...
	type NaiveTableConfig<A extends TableApiFn> = Pick<
		import('@lifeatm/hooks').TableConfig<A, GetTableData<A>, TableColumn<TableDataWithIndex<GetTableData<A>>>>,
